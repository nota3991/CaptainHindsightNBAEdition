...
'''
plt.bar(1,ptsdict[1],facecolor="#9999ff",edgecolor="white")
plt.title('The average pts for first pick')
plt.show()

plt.bar(1,trbdict[1],facecolor="#9999ff",edgecolor="white")
plt.title('The average trb for first pick')
plt.show()

plt.bar(1,astdict[1],facecolor="#9999ff",edgecolor="white")
plt.title('The average ast for first pick')
plt.show()
'''